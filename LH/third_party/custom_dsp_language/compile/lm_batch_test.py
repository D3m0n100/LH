...
from lm_interpreter import LMInterpreter, parse_header, disassemble, FB_NAMES, OPCODES
...
def run_execution_test(filepath: str) -> dict:
    ...
    try:
        vm = LMInterpreter(verbose=False, trace=False)
        vm.load(filepath)
