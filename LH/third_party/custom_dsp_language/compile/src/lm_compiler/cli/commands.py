"""
LM Compiler Command Line Interface
...
def main(verbose):
    """LM Compiler - A CODESYS-style compiler for LM assembly language"""
...
def repl():
    ...
    console.print("[bold blue]LM Compiler Interactive Mode[/bold blue]")
