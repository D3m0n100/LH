...
public:
    ...
    using ReadCompletion = std::function<void(bool, QHash<QString, QVariant>,
        QString, QHash<QString, CommError>, BackendStatusSnapshot)>;
    virtual bool supportsAsyncRead() const { return false; }
    virtual void readPointsAsync(const QStringList&, int, std::shared_ptr<std::atomic_bool>,
                                QObject*, ReadCompletion completed)
    {
        completed(false, {}, QStringLiteral("Asynchronous reads are unsupported"), {}, statusSnapshot());
    }
    ...
    /**
     * Request cancellation of ongoing download or long-running operation.
     */
    virtual void cancelDownload() {}

    /**
     * Reset cancellation flag before starting a new download operation.
     */
    virtual void resetDownloadCancellation() {}
