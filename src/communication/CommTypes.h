...
struct EthernetConfig : public CommConfigBase
{
    ...
    static constexpr int MAX_RECEIVE_BUFFER_SIZE = 1048576;
    ...
    bool fromVariantMap(const QVariantMap& map) override {
        *this = EthernetConfig();
        ...
        ok = commReadStrictInt(map, "receiveBufferSize", DEFAULT_RECEIVE_BUFFER_SIZE, 1,
                               MAX_RECEIVE_BUFFER_SIZE, &receiveBufferSize) && ok;
